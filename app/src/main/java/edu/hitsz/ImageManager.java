...
public class ImageManager {
    ...
    public static void initImage(Context context){
        ...
        CLASSNAME_IMAGE_MAP.put(Prop_Blood.class.getName(),HP_SUPPLY_IMAGE);
        CLASSNAME_IMAGE_MAP.put(Prop_Bomb.class.getName(),BOMB_SUPPLY_IMAGE);
        CLASSNAME_IMAGE_MAP.put(Prop_Bullet.class.getName(),FIRE_SUPPLY_IMAGE);
    }
